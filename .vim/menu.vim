...
" Doro menu
" ---------------------------------------------------------------------------
" an 800.100 &Doro.&Shortcut.File\ Viewer<Tab><F5>        <ESC>:NERDTreeToggle<CR>
" an 800.120 &Doro.&Shortcut.TagList<Tab><F6>             <ESC>:TlistToggle<CR>
" an 800.140 &Doro.&Shortcut.TraceExplorer<Tab><F7>       <ESC>:TSWindowToggle<CR>

" an 800.160 &Doro.&Shortcut.QuickFix.Switch<Tab><F8>     <ESC>:QFSwitch<CR>
" an 800.162 &Doro.&Shortcut.QuickFix.Older<Tab><S-F8>    <ESC>:colder<CR>
" an 800.164 &Doro.&Shortcut.QuickFix.Newer<Tab><C-F8>    <ESC>:cnewer<CR>
" an 800.166 &Doro.&Shortcut.QuickFix.Prev\ Bug<Tab><C-p> <ESC>:cprev<CR>
" an 800.168 &Doro.&Shortcut.QuickFix.Next\ Bug<Tab><C-n> <ESC>:cnext<CR>

" an 800.180 &Doro.&Shortcut.VisualMark.Mark<Tab><F9>     <ESC><Plug>Vm_toggle_sign<CR>
" an 800.182 &Doro.&Shortcut.VisualMark.Prev<Tab><S-F9>   <ESC><Plug>Vm_goto_prev_sign<CR>
" an 800.184 &Doro.&Shortcut.VisualMark.Next<Tab><C-F9>   <ESC><Plug>Vm_goto_next_sign<CR>

" an 800.200 &Doro.&Shortcut.Find\ in\ Files.Search<Tab>f/                    <ESC>:Grep 
" an 800.200 &Doro.&Shortcut.Find\ in\ Files.Search\ Cursor\ Word<Tab>\\vv    <nop>
" an 800.200 &Doro.&Shortcut.Find\ in\ Files.Options<Tab>\\vo                 <ESC>:GrepOptions
" 
" an 800.220 &Doro.&Shortcut.Find\ Files<Tab>ff           <ESC>:FindFile 
...
"DRR an 10.610 &File.Sa&ve-Exit<Tab>:wqa             :confirm wqa<CR>
...
"DRR an 20.330 &Edit.Rep&eat<Tab>\.                  .
...
"DRR nnoremenu 20.370 &Edit.Put\ &Before<Tab>[p      [p
"DRR inoremenu        &Edit.Put\ &Before<Tab>[p      <C-O>[p
"DRR nnoremenu 20.380 &Edit.Put\ &After<Tab>]p       ]p
"DRR inoremenu        &Edit.Put\ &After<Tab>]p       <C-O>]p
if has("win32") || has("win16")
  vnoremenu 20.390 &Edit.&Delete<Tab>x		x
endif
"DRR noremenu  <script> <silent> 20.400 &Edit.&Select\ All<Tab>ggVG  :<C-U>call <SID>SelectAll()<CR>
"DRR inoremenu <script> <silent> 20.400 &Edit.&Select\ All<Tab>ggVG  <C-O>:call <SID>SelectAll()<CR>
"DRR cnoremenu <script> <silent> 20.400 &Edit.&Select\ All<Tab>ggVG  <C-U>call <SID>SelectAll()<CR>
...
an 20.422 &Edit.Find\ &in\ Files.Search<Tab>f/                    <ESC>:Grep 
an 20.422 &Edit.Find\ &in\ Files.Search\ Cursor\ Word<Tab>\\vv    <nop>
an 20.422 &Edit.Find\ &in\ Files.Options<Tab>\\vo                 <ESC>:GrepOptions

an 20.425 &Edit.Find\ Fi&les<Tab>ff                               <ESC>:FindFile 
...
an 20.475        &Edit.-SEP4-                           <Nop>
an 20.480        &Edit.Options\ &Window                 :options<CR>
an 20.485        &Edit.Startup\ &Settings               :call <SID>EditVimrc()<CR>
...
an 40.300.100 &Tools.Code\ &Trace.&Jump\ to\ this\ tag<Tab>g^]       <C-]>
an 40.300.100 &Tools.Code\ &Trace.&Jump\ to\ this\ tag<Tab>g^]       <C-]>
vunmenu       &Tools.Code\ &Trace.&Jump\ to\ this\ tag<Tab>g^]
vnoremenu     &Tools.Code\ &Trace.&Jump\ to\ this\ tag<Tab>g^]       <C-]>
an 40.300.110 &Tools.Code\ &Trace.Jump\ &back<Tab>^T                 <C-T>
an 40.300.120 &Tools.Code\ &Trace.Build\ &Tags\ File<Tab><C-F12>     :!ctags -R --c++-kinds=+p --fields=+iaS --extra=+q .<CR>
an 40.300.130 &Tools.Code\ &Trace.Set\ Editor\ Win<Tab>              :TSSetFocusWin<CR>
an 40.300.100 &Tools.Code\ &Trace.&Jump\ to\ this\ tag<Tab>g^]       <C-]>
an 40.300.100 &Tools.Code\ &Trace.&Jump\ to\ this\ tag<Tab>g^]       <C-]>
...
an 40.310.70  &Tools.F&uzzyFinder.MRU-&File<Tab>fmf                   <ESC>:FuzzyFinderMruFile<CR>
...
"DRR if has("folding") || has("spell")
"DRR   an 40.330 &Tools.-SEP1-                                               <Nop>
"DRR endif
...
an 40.360.360 &Tools.&QuickFix.&Switch<Tab><F8>                       :QFSwitch<CR>
an 40.360.360 &Tools.&QuickFix.N&ewer\ List<Tab><C-F8>                :cnewer<CR>
an 40.360.360 &Tools.&QuickFix.&Older\ List<Tab><S-F8>                :colder<CR>
an 40.360.365 &Tools.&QuickFix.-SEP1-                                 <Nop>
an 40.360.370 &Tools.&QuickFix.&Make<Tab>:make                        :make<CR>
an 40.360.370 &Tools.&QuickFix.&Next\ Error<Tab><C-n>                 :cn<CR>
an 40.360.370 &Tools.&QuickFix.&Previous\ Error<Tab><S-p>             :cp<CR>
an 40.360.370 &Tools.&QuickFix.&List\ Errors<Tab>:cl                  :cl<CR>
an 40.360.380 &Tools.&QuickFix.L&ist\ Messages<Tab>:cl!               :cl!<CR>
an 40.360.430.50 &Tools.&QuickFix.Error\ &Window.&Update<Tab>:cwin    :cwin<CR>
an 40.360.430.60 &Tools.&QuickFix.Error\ &Window.&Open<Tab>:copen     :copen<CR>
an 40.360.430.70 &Tools.&QuickFix.Error\ &Window.&Close<Tab>:cclose   :cclose<CR>


" Setup the Tools.QuickFix submenu
...
while strlen(s:n) > 0
  ...
  exe "an 40.360.440." . s:idx . ' &Tools.&QuickFix.Se&T\ Compiler.' . s:name . " :compiler " . s:name . "<CR>"
  unlet s:name
  unlet s:i
  let s:idx = s:idx + 10
endwhile
...
if has("diff")
  an 40.550.100 &Tools.&Diff.&Update            :diffupdate<CR>
  an 40.550.110 &Tools.&Diff.&Get\ Block        :diffget<CR>
  vunmenu &Tools.&Diff.&Get\ Block
  vnoremenu &Tools.&Diff.&Get\ Block            :diffget<CR>
  an 40.550.120 &Tools.&Diff.&Put\ Block        :diffput<CR>
...
an 50.20 &View.TagList<Tab><F6>             <ESC>:TlistToggle<CR>
an 50.20 &View.TraceExplorer<Tab><F7>       <ESC>:TSWindowToggle<CR>
...
while strlen(s:n) > 0
  ...
  " Ignore case for VMS and windows
  let s:name = substitute(s:name, '\c.*[/\\:\]]\([^/\\:]*\)\.vim', '\1', '')
  exe "an 50.30." . s:idx . ' &View.C&olor\ Scheme.' . s:name . " :colors " . s:name . "<CR>"
  unlet s:name
  unlet s:i
  let s:idx = s:idx + 10
endwhile
...
if exists("do_syntax_sel_menu")
  ...
  an 50.50.10 &View.&Syntax.&Show\ filetypes\ in\ menu   :let do_syntax_sel_menu = 1<Bar>runtime! synmenu.vim<Bar>aunmenu &View.Syntax.&Show\ filetypes\ in\ menu<CR>
  an 50.50.195 &View.&Syntax.-SEP1-              <Nop>
endif


an 50.50.210 &View.&Syntax.&Off                  :syn off<CR>
"
...
if !exists("did_install_syntax_menu")
  an 50.50.212 &View.&Syntax.&Manual             :syn manual<CR>
  an 50.50.214 &View.&Syntax.A&utomatic          :syn on<CR>
  an <silent> 50.50.216 &View.&Syntax.on/off\ for\ &This\ file :call <SID>SynOnOff()<CR>
...
an 50.50.700 &View.&Syntax.-SEP3-                <Nop>
an 50.50.710 &View.&Syntax.Co&lor\ test          :sp $VIMRUNTIME/syntax/colortest.vim<Bar>so %<CR>
an 50.50.720 &View.&Syntax.&Highlight\ test      :runtime syntax/hitest.vim<CR>
an 50.50.730 &View.&Syntax.&Convert\ to\ HTML    :runtime syntax/2html.vim<CR>

endif " !exists("did_install_syntax_menu")

if has("win32") || has("win16") || has("gui_motif") || has("gui_gtk") || has("gui_kde") || has("gui_photon") || has("gui_mac")
  an 50.60 &View.Fo&nt\.\.\.                     :set guifont=*<CR>
endif
