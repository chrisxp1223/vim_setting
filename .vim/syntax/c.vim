...
syn match cOperator2	"[.!~*&%<>^|=,+-]"
syn match cOperator4	"/[^/*=]"me=e-1
syn match cOperator4	"/$"
syn match cOperator4	"[][(){};\\]"
...
" HiLink cUserLabel	Label
  ...
  HiLink cOperator2	Operator2
  HiLink cOperator3	Operator3
  HiLink cOperator4	Operator4
  ...
  hi Function		gui=NONE guifg=#ee4400
  ...
  hi Operator		gui=NONE guifg=#440000
  hi Operator2		gui=NONE guifg=#40FFFF
  hi Operator3		gui=bold guifg=#60ff60
  "hi Operator4		gui=bold guifg=#AA2222
  hi Operator4		gui=NONE guifg=#FFFF22
  hi OperatorBold	gui=bold guifg=#444444
"  hi StdName		gui=bold guifg=#5276e6
"  hi Name		gui=NONE guifg=#5276e6
  hi Name		gui=NONE guifg=#FFFFFF
  hi BlockBraces	gui=bold guifg=#1111FF
  hi Special		gui=NONE guifg=#a000a0
  hi Comment		gui=NONE guifg=#008800
...
hi Normal		gui=NONE guifg=#11FFFF 
